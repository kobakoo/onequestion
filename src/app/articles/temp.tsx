...
const data = {
	...
	questionHeading: "問15",
	question:
		"戦時体制のもとで労働力や物資について述べた文として<strong>誤っているもの</strong>を、次のア～エから一つ選び、記号で答えなさい。",
	answer:
		"ア、 新たに結成された大政翼賛会が、労働力や物資を動員できるようになった。",
	explanation: `因果関係が間違っています。1940年にほとんどの政党や政治団体が解散して大政翼賛会が結成され、国民の国家総動員が固められました。しかし、それ以前の1938年にすでに国家総動員法が制定されており、労働力や物資の動員が可能であったため、誤りです。`,
} as ArticleData;
